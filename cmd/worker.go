...
*/
func makeEnumWorker(ctx context.Context, usernames <-chan string, wg *sync.WaitGroup, completionChan chan struct{}) {
	defer func() {
		wg.Done()
		// Send a signal on completionChan when the goroutine finishes.
